...
import es.caib.rfhab.back.validator.webdb.PluginWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="plugin.plugin.plural", order=110, group="WEBDB")
@Controller
@RequestMapping(value = "/webdb/plugin")
@SessionAttributes(types = { PluginForm.class, PluginFilterForm.class })
public class PluginController
    extends es.caib.rfhab.back.controller.RFHabBaseController<Plugin, java.lang.Long> implements PluginFields {

  @EJB(mappedName = es.caib.rfhab.ejb.PluginService.JNDI_NAME)
  protected es.caib.rfhab.ejb.PluginService pluginEjb;
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Plugin
   */
  @RequestMapping(value = "/cancel")
  public String cancelPlugin(HttpServletRequest request,HttpServletResponse response) {
