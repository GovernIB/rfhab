package es.caib.rfhab.api.externa.secure.exemplesecuritzat;
...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST EXTERNA de RFHab - Exemple de Servei Securitzat",
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/rfhab/tree/rfhab-1.0/rfhab-api-externa-client-exemplesecure-v1"))
...
public class ExempleSeguritzatService {
    ...
    @Path("/echo")
    @GET
    @RolesAllowed({ Constants.RFH_ADMIN, Constants.RFH_USER })
