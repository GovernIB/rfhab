...
public class Configuracio implements Constants {
    ...
    public static Properties getAppProperties() {
        if (appProperties == null) {
            appProperties = loadPropertiesFromKey(Constants.RFHAB_PROPERTY_BASE + "properties");
        }
    ...
    public static Properties getAppSystemProperties() {
        if (appSystemProperties == null) {
            appSystemProperties = loadPropertiesFromKey(Constants.RFHAB_PROPERTY_BASE + "system.properties");
        }
    ...
    public static boolean isDesenvolupament() {
        ...
        return "true".equalsIgnoreCase(getAppProperties().getProperty(RFHAB_PROPERTY_BASE + "development"));
    }
    ...
    public static String getAppName() {
        return getAppProperties().getProperty(RFHAB_PROPERTY_BASE + "name", "RFHab");
    }

    public static String getFrontUrl() {
        return getAppProperties().getProperty(RFHAB_PROPERTY_BASE + "url.front");
    }

    public static String getBackUrl() {
        return getAppProperties().getProperty(RFHAB_PROPERTY_BASE + "url.back");
    }

    public static String getAjudaViaTelefon() {
        return getAppProperties().getProperty(RFHAB_PROPERTY_BASE + "ajuda.viatelefon");
    }

    public static String getAjudaViaWeb() {
        return getAppProperties().getProperty(RFHAB_PROPERTY_BASE + "ajuda.viaweb");
    }

    public static String getAjudaViaEmail() {
        return getAppProperties().getProperty(RFHAB_PROPERTY_BASE + "ajuda.viaemail");
    }

    public static String getDefaultLanguage() {
        return getAppProperties().getProperty(RFHAB_PROPERTY_BASE + "defaultlanguage", "ca");
    }
    ...
    public static Long getMaxFitxerAdaptatSizeInBytes() {
        return getLongAppProperty(RFHAB_PROPERTY_BASE + "maxfitxeradaptatsizeinbytes");
    }

    public static File getFilesDirectory() {
        String path = getAppSystemProperties().getProperty(RFHAB_PROPERTY_BASE + "filesdirectory");
        if (path == null) {
            throw new RuntimeException("No existeix la propietat '" + RFHAB_PROPERTY_BASE + "filesdirectory'"
                    ...
                    + " i incloure la propietat '" + RFHAB_PROPERTY_BASE
        ...
        if (!filesFolder.exists()) {
            throw new RuntimeException("El directori indicat a la propietat '" + RFHAB_PROPERTY_BASE
                    ...
                    + System.getProperty(RFHAB_PROPERTY_BASE + "system.properties")
    ...
    public static String getCarregadorMassiuEntitatId() {
        return getAppSystemProperties().getProperty(CARREGADORMASSIU_PROPERTY_BASE + "entitatcarregadorid");
    }
