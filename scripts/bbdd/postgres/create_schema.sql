...
create sequence rfh_usuarientitat_seq start 1000 increment 1;
    ...
    create table rfh_funcionarilloc (
       funcionarillocid int8 not null,
        datacreacio timestamp not null,
        datafi date,
        datainici date,
        funcionariid int8 not null,
