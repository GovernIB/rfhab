package es.caib.rfhab.api.interna.secure.exempleenumsecuritzat;

import es.caib.rfhab.commons.utils.Constants;
import es.caib.rfhab.logic.utils.I18NLogicUtils;
...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST INTERNA de RFHab - Exemple de Servei Securitzat",
                description = "Conjunt de Serveis REST de RFHab per ser accedits emprant autenticació",
                ...
                contact = @Contact(
                        ...
                        email = "governdigital@ibdigital.caib.es",
                        url = "https://governdigital.fundaciobit.org")),
        externalDocs = @ExternalDocumentation(
                description = "Java Client (GovernIB Github)",
                url = "https://github.com/GovernIB/rfhab/tree/rfhab-1.0/rfhab-api-interna-client-exemplesecure-v1"))
    ...
    public SendMessageResult sendNotificationToMobile(
        ...
        try {
            ...
            switch ((int) (System.nanoTime() % 10)) {
                ...
                case 1:
                    // Simula un error en els paràmetres
                    throw new RestException("El codi de notificacio 'notificationCode' no està registrat.", Status.BAD_REQUEST);
