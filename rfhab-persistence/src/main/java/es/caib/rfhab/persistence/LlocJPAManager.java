...
public class LlocJPAManager
    ...
    public Lloc create( java.lang.String _codiLloc_, java.lang.String _nom_, long _entitatID_, long _unitatID_, int _personalOamr_, java.sql.Timestamp _dataalta_, java.sql.Timestamp _dataCreacio_, java.sql.Timestamp _dataBaixa_, java.lang.String _observacions_, java.lang.String _codiLlocPropi_) throws I18NException {
        LlocJPA __bean =  new LlocJPA(_codiLloc_,_nom_,_entitatID_,_unitatID_,_personalOamr_,_dataalta_,_dataCreacio_,_dataBaixa_,_observacions_,_codiLlocPropi_);
