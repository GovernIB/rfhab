 ...
 */
@Controller
public abstract class RFHabFilesBaseController<I extends IGenAppEntity,PK extends Object,F extends BaseForm> extends CommonFilesBaseController<I,PK,F,Fitxer>{
	...
	getFilesFormManager() {
    return new RFHabFilesFormManager(fitxerEjb);
  }
