...
@Table(name = "rfh_idioma" , indexes = { 
        @Index(name="rfh_idioma_pk_i", columnList = "idiomaid")})
@SequenceGenerator(name="IDIOMA_SEQ", sequenceName="rfh_idioma_seq", allocationSize=1, initialValue=1000)
...
// EXP  Field:idiomaid | Table: rfh_usuari | Type: 0  
