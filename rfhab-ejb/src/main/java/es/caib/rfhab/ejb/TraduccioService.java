...
import es.caib.rfhab.persistence.TraduccioIJPAManager;
import es.caib.rfhab.model.dao.ITraduccioManager;
...
public interface TraduccioService extends TraduccioIJPAManager,ITraduccioManager {
    ...
    public static final String JNDI_NAME = "java:app/rfhab-ejb/TraduccioEJB!es.caib.rfhab.ejb.TraduccioService";
