...
document.addEventListener("DOMContentLoaded", function(event) {
	...
	<c:if test="${not rolsFuncionari.isEmpty()}">
		<c:forEach items="${rolsFuncionari}" var="rolFuncionari">
			console.log("Funcionario: ${rolFuncionari.rolID}");
			document.getElementById("rolID_${rolFuncionari.rolID}").checked = true;
		</c:forEach>
	</c:if>
