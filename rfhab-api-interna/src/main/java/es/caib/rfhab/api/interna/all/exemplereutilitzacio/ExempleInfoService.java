package es.caib.rfhab.api.interna.all.exemplereutilitzacio;
...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST INTERNA de RFHab - Dades Obertes",
                description = "Exemple de Servei de Dades Reutilitzables emprant paginació i retorn complet de dades",
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/rfhab/tree/rfhab-1.0/rfhab-api-interna-client-dadesobertes-v1"))
