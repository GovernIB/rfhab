package es.caib.rfhab.api.interna.all.general;
...
public class GeneralPublicService {

        protected final Logger log = Logger.getLogger(GeneralPublicService.class);
        ...
        public ExemplePojo versio(
                        ...
                        @Parameter(description = "Codi de l'idioma", required = false, examples = {
                                        @io.swagger.v3.oas.annotations.media.ExampleObject(name = "Català", value = "ca"),
                                        @io.swagger.v3.oas.annotations.media.ExampleObject(name = "Castellano", value = "es") }, schema = @Schema(implementation = String.class)) @Pattern(regexp = "^ca|es$") @QueryParam("idioma") String idioma)
