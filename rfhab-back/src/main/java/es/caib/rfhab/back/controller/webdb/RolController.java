 ...
 * @author GenApp
 */
@MenuOption(labelCode="rol.rol.plural", order=120, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/rol")
@SessionAttributes(types = { RolForm.class, RolFilterForm.class })
@Tile(name="rolFormWebDB", contentJsp="/WEB-INF/jsp/webdb/rolForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="rol.rol")})
@Tile(name="rolListWebDB", contentJsp="/WEB-INF/jsp/webdb/rolList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="rol.rol") })
