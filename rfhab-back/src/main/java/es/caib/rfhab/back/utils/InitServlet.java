...
import es.caib.rfhab.logic.utils.LogicUtils;
    ...
    public void init(ServletConfig config) throws ServletException {
            ...
            public void run() {
                try {
                    MenuOptionManager.setDiscoverMenuOptionAnnotations(
                            new DiscoverMenuOptionAnnotations(Constants.RFHAB_PROPERTY_BASE + "back.controller"));
                } catch (Throwable th) {
        ...
        try {
            ...
            String[] basenames = { "missatges", // /WEB-INF/classes/
                    "logicmissatges", "genapp", "rfhab_genapp" };
            ...
            if (plugins == null || plugins.size() == 0) {
                ...
                for (Class<? extends IExportDataPlugin> class1 : plugins) {
                    ...
                    if (edp == null) {
                        ...
                        DataExporterManager.addDataExporter(new es.caib.rfhab.back.utils.RFHabDataExporter(edp));
                    }
                }
            }
