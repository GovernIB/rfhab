...
public class UnitatAdministrativa extends EntidadBase {
	...
	public UnitatAdministrativa (es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.UnidadAdministrativa ua, String urlBase,String idioma,boolean hateoasEnabled ) {
	...
	public <T> void fill(T ua, String urlBase,String idioma, boolean hateoasEnabled ) {
		...
		if(((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.UnidadAdministrativa)ua).getTratamiento()!=null ) {					
			this.tratamiento = new Tratamiento(((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.UnidadAdministrativa)ua).getTratamiento(),urlBase,idioma,hateoasEnabled);				
		}		
