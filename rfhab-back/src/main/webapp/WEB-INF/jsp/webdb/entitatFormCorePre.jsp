  ...
  <div class="module_content">
    ...
    <c:if test="${not __theForm.view}">    <c:forEach items="${__theForm.hiddenFields}" var="hiddenFieldF" >
      ...
      <c:if test="${gen:hasProperty(__theForm.entitat,hiddenField)}">
        <form:errors path="entitat.${hiddenField}" cssClass="errorField alert alert-danger" />
    ...
    <table id="entitat_tableid" class="tdformlabel table-sm table table-bordered table-striped marTop10 table-genapp table-genapp-form" > 
    <tbody>      
