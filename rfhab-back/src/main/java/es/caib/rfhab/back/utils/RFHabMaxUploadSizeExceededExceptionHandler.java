 ...
 * 
 */
public class RFHabMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof RFHabMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof RFHabMaxUploadSizeExceededException) {
          msgCode = ((RFHabMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
