...
import es.caib.rfhab.persistence.validator.PluginValidator;
...
public class PluginWebValidator extends AbstractWebValidator<PluginForm, Plugin>
  ...
  @javax.ejb.EJB(mappedName = es.caib.rfhab.ejb.PluginService.JNDI_NAME)
