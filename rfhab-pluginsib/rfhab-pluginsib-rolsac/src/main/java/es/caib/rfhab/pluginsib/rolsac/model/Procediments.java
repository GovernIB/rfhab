package es.caib.rfhab.pluginsib.rolsac.model;
...
import es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.TraduccionUA;
import es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.UnidadAdministrativa;
...
public class Procediments extends EntidadBase {
	 ...
	 */
	public Procediments(final es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.Procedimiento elem, final String urlBase, final String idioma,
			final boolean hateoasEnabled) {
		super(elem, urlBase, idioma, hateoasEnabled);

		try {
			// copiamos los datos que no tienen la misma estructura:
			if (((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.ProcedimientoLocal) elem).getSilencio() != null) {
				this.silencio = new Silencis(((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.ProcedimientoLocal) elem).getSilencio(), urlBase,
						idioma, hateoasEnabled);
			}

			// copiamos los datos que no tienen la misma estructura:
			if (((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.ProcedimientoLocal) elem).getIniciacion() != null) {
				this.iniciacion = new Iniciacions(((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.ProcedimientoLocal) elem).getIniciacion(),
						urlBase, idioma, hateoasEnabled);
			}

			// copiamos los datos que no tienen la misma estructura:
			if (((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.ProcedimientoLocal) elem).getLopdLegitimacion() != null) {
				this.lopdLegitimacion = new LopdLegitimacion();
				this.lopdLegitimacion.setIdentificador(
						((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.ProcedimientoLocal) elem).getLopdLegitimacion().getIdentificador());
				this.lopdLegitimacion.setNombre(
						((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.TraduccionLopdLegitimacion) ((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.ProcedimientoLocal) elem)
								.getLopdLegitimacion().getTraduccion(idioma)).getNombre());
			}

			if (((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.ProcedimientoLocal) elem).isComun()) {
				...
				final String lopdResponsable = getUAByDir3(
						((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.ProcedimientoLocal) elem).getServicioResponsable(), idioma);
