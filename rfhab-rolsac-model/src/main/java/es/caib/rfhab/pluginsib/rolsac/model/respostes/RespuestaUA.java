...
import es.caib.rfhab.pluginsib.rolsac.model.UnitatAdministrativa;
...
@XmlRootElement
@ApiModel(value = Constantes.TXT_RESPUESTA + Constantes.ENTIDAD_UA, description = Constantes.TXT_RESPUESTA
        + Constantes.ENTIDAD_UA)
