...
public class RegistreActivitatFuncionariService extends RestUtils {
	...
	public String registreActivitat(
			...
			@Parameter(name = "language", description = "Idioma en que s'han de retornar les dades(Només suportat 'ca' o 'es')", in = ParameterIn.QUERY, required = false, examples = {
					...
					@ExampleObject(name = "Castellano", value = "es") }, schema = @Schema(defaultValue = "ca", implementation = String.class)) @QueryParam(RegistreActivitatServiceParams.LANGUAGE) String language,
			@Parameter(description = "NIF del/de la funcionari/ària que realitza la activitat", required = true, example = "44444444A", schema = @Schema(type = "string")) @NotNull @QueryParam(RegistreActivitatServiceParams.FUNCIONARI) String funcionariNif,
			@Parameter(description = "Tipus de l\'activitat:<br />&emsp;<i>"
					+ RegistreActivitatTipusValues.DESCRIPTION_ALL_VALUES
					+ "</i>", required = true, example = "", schema = @Schema(type = "RegistreActivitatTipus", description = RegistreActivitatTipusValues.DESCRIPTION_ALL_VALUES)) @NotNull @QueryParam(RegistreActivitatServiceParams.TIPUS) RegistreActivitatTipus tipus,
			@Parameter(description = "Data de registre de l\'activitat", required = true, example = "2025-08-31T06:15:00+00:00", schema = @Schema(implementation = String.class, pattern = DATE_PATTERN_ISO8601_DATE_AND_TIME)) @NotNull @QueryParam(RegistreActivitatServiceParams.DATA) String dataActivitatStr,

			// COPIA
			@Parameter(description = "Identificador de còpia autèntica, podria ser un identificador intern de digitalib o bé el csv de la còpia autèntica. Obligatori pel tipus d'activitat 1", required = false, example = "klñjjskadfjklsdkl/asdlfjsd", schema = @Schema(type = "string")) @QueryParam(RegistreActivitatServiceParams.IDENTIFICADORCOPIAAUTENTICA) String csvCopiaAutentica,
			...
			@Parameter(description = "Segon Llinatge de l\'interessat/da del tràmit. Obligatori pel tipus d'activitat 3", required = false, example = "", schema = @Schema(type = "string"), hidden = true) @QueryParam(RegistreActivitatServiceParams.LLINATGE2INTERESSAT) String llinatge2Interessat,
			@Parameter(description = "Tipus d'identificació de l\'interessat/da del tràmit. Obligatori pel tipus d'activitat 3:<br />&emsp;<i>"
					...
					+ "</i>", required = false, example = "", schema = @Schema(type = "IdentificacioTipus", description = IdentificacioTipusValues.DESCRIPTION_ALL_VALUES), hidden = true) @QueryParam(RegistreActivitatServiceParams.TIPUSIDENTIFICACIOINTERESSAT) IdentificacioTipus tipusIdentificacioInteressat,
			@Parameter(description = "Identificació de l\'interessat/da del tràmit. Obligatori pel tipus d'activitat 3", required = false, example = "", schema = @Schema(type = "string"), hidden = true) @QueryParam(RegistreActivitatServiceParams.IDENTIFICACIOINTERESSAT) String identificacioInteressat,
			@Parameter(description = "Nom del/de la representant de l\'interessat/da del tràmit. Obligatori pel tipus d'activitat 3", required = false, example = "", schema = @Schema(type = "string"), hidden = true) @QueryParam(RegistreActivitatServiceParams.NOMREPRESENTANT) String nomRepresentant,
			@Parameter(description = "Primer Llinatge del/de la representant de l\'interessat/da del tràmit. Obligatori pel tipus d'activitat 3", required = false, example = "", schema = @Schema(type = "string"), hidden = true) @QueryParam(RegistreActivitatServiceParams.LLINATGE1REPRESENTANT) String llinatge1Representant,
			@Parameter(description = "Segon Llinatge del/de la representant de l\'interessat/da del tràmit. Obligatori pel tipus d'activitat 3", required = false, example = "", schema = @Schema(type = "string"), hidden = true) @QueryParam(RegistreActivitatServiceParams.LLINATGE2REPRESENTANT) String llinatge2Representant,
			@Parameter(description = "Tipus d'identificació del/de la representant de l\'interessat/da del tràmit. Obligatori pel tipus d'activitat 3:<br />&emsp;<i>"
					+ IdentificacioTipusValues.DESCRIPTION_ALL_VALUES
					+ "</i>", required = false, example = "", schema = @Schema(type = "IdentificacioTipus", description = IdentificacioTipusValues.DESCRIPTION_ALL_VALUES), hidden = true) @QueryParam(RegistreActivitatServiceParams.TIPUSIDENTIFICACIOREPRESENTANT) IdentificacioTipus tipusIdentificacioRepresentant,
			@Parameter(description = "Identificació del/de la representant de l\'interessat/da del tràmit. Obligatori pel tipus d'activitat 3", required = false, example = "", schema = @Schema(type = "string"), hidden = true) @QueryParam(RegistreActivitatServiceParams.IDENTIFICACIOREPRESENTANT) String identificacioRepresentant,
			@Parameter(description = "Identificació de l'expedient d'Arxiu que conté el Model de consentiment firmat. Obligatori pel tipus d'activitat 3", required = false, example = "", schema = @Schema(type = "string"), hidden = true) @QueryParam(RegistreActivitatServiceParams.ARXIUEXPEDIENTID) String arxiuExpedientId,
			@Parameter(description = "Identificació del document d'Arxiu que conté el Model de consentiment firmat. Obligatori pel tipus d'activitat 3", required = false, example = "", schema = @Schema(type = "string"), hidden = true) @QueryParam(RegistreActivitatServiceParams.ARXIUDOCUMENTID) String arxiuDocumentId,

			// No emprats... (ocults)
			@Parameter(description = "Codi SIA associat a l\'activitat", required = false, example = "", array = @ArraySchema(schema = @Schema(type = "string")), hidden = true) @QueryParam(RegistreActivitatServiceParams.CODISIA) String codiSia,
			@Parameter(description = "Codi de l\'autorització associat a l\'activitat", required = false, example = "", array = @ArraySchema(schema = @Schema(type = "string")), hidden = true) @QueryParam(RegistreActivitatServiceParams.AUTORITZACIO) String autoritzacio) {
