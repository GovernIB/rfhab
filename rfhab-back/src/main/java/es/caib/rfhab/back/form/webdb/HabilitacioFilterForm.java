 ...
 */
@Component
public class HabilitacioFilterForm extends RFHabBaseFilterForm implements HabilitacioFields {
  ...
  public HabilitacioFilterForm() {
  }
  
  public HabilitacioFilterForm(HabilitacioFilterForm __toClone) {
    super(__toClone);
