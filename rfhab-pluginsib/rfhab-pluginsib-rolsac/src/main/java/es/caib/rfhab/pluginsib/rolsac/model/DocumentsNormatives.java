...
public class DocumentsNormatives extends EntidadBase {
	...
	public DocumentsNormatives (es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.DocumentoNormativa elem, String urlBase,String idioma,boolean hateoasEnabled ) {
