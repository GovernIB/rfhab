...
public class LlocJPAManager
    ...
    public Lloc create( java.lang.String _codiLlocPropi_, java.lang.String _codiLloc_, java.lang.String _expansio_, java.lang.String _nom_, long _entitatID_, long _unitatID_, java.sql.Timestamp _dataalta_, java.sql.Timestamp _dataCreacio_, java.sql.Timestamp _dataBaixa_, int _personalOamr_, java.lang.String _observacions_) throws I18NException {
        LlocJPA __bean =  new LlocJPA(_codiLlocPropi_,_codiLloc_,_expansio_,_nom_,_entitatID_,_unitatID_,_dataalta_,_dataCreacio_,_dataBaixa_,_personalOamr_,_observacions_);
