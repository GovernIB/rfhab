...
public class Serveis extends EntidadBase {
	 ...
	 */
	public Serveis(final es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.Servicio elem, final String urlBase, final String idioma,
		...
		try {
			...
			if (elem.getLopdLegitimacion() != null) {
				...
				this.lopdLegitimacion.setNombre(((es.caib.rfhab.pluginsib.rolsac.model.ibitrolsac.TraduccionLopdLegitimacion) elem
