...
public final class IdentificacioTipusValues {
    static final String DNI_NAME = "DNI";
    static final String DNI_VALUE_STR = "1";
    static final String DNI_DESCRIPTION = "DNI";
    ...
    public static final String DESCRIPTION_ALL_VALUES = 
        DNI_VALUE_STR + DESCRIPTION_ALL_NAME_VALUE_SEPARATOR + DNI_DESCRIPTION + DESCRIPTION_ALL_VALUES_SEPARATOR
