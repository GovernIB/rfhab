...
@Table(name = "rfh_usuarientitat" , indexes = { 
        @Index(name="rfh_usuarientitat_pk_i", columnList = "usuarientitatid"),
        @Index(name="rfh_usuarient_entitatid_fk_i", columnList = "entitatid"),
        @Index(name="rfh_usuarient_usuariid_fk_i", columnList = "usuariid")},
           uniqueConstraints = {
            @UniqueConstraint(name="rfh_usuarient_multiple_uk", columnNames={"entitatid","usuariid"}) } )
@SequenceGenerator(name="USUARIENTITAT_SEQ", sequenceName="rfh_usuarientitat_seq", allocationSize=1, initialValue=1000)
...
public class UsuariEntitatJPA implements UsuariEntitat {
  ...
  public UsuariEntitatJPA(long usuariEntitatID , long entitatID , long usuariID , boolean actiu) {
  ...
  public UsuariEntitatJPA(long entitatID , long usuariID , boolean actiu) {
    this.entitatID=entitatID;
    this.usuariID=usuariID;
    this.actiu=actiu;
}
...
// IMP Field:entitatid | Table: rfh_entitat | Type: 1  
    ...
    @JoinColumn(name = "entitatid", referencedColumnName ="entitatID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="rfh_usuarient_entitat_entit_fk"))
...
// IMP Field:usuariid | Table: rfh_usuari | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "usuariid", referencedColumnName ="usuariID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="rfh_usuarient_usuari_usuari_fk"))
