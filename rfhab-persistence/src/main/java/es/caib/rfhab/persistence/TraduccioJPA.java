...
@Table(name = "rfh_traduccio" , indexes = { 
        @Index(name="rfh_traduccio_pk_i", columnList = "traduccioid")})
@SequenceGenerator(name="TRADUCCIO_SEQ", sequenceName="rfh_traduccio_seq", allocationSize=1, initialValue=1000)
...
// EXP  Field:nomid | Table: rfh_rol | Type: 0  
  ...
  @ElementCollection(fetch= FetchType.EAGER, targetClass = es.caib.rfhab.persistence.TraduccioMapJPA.class)
  @Cascade(value=org.hibernate.annotations.CascadeType.ALL)
  @LazyCollection(value= LazyCollectionOption.FALSE)
  @JoinTable(name="rfh_traducciomap",joinColumns={@JoinColumn(name="traducciomapid")}, foreignKey=@ForeignKey(name="rfh_traducmap_traduccio_fk"))
  @javax.persistence.MapKeyColumn(name="idiomaid")
  private Map<String, es.caib.rfhab.persistence.TraduccioMapJPA> traduccions =  new HashMap<String, es.caib.rfhab.persistence.TraduccioMapJPA>();

  public Map<String, es.caib.rfhab.persistence.TraduccioMapJPA> getTraduccions() {
    return this.traduccions;
  }

  public void setTraduccions(Map<String, es.caib.rfhab.persistence.TraduccioMapJPA> _traduccions_) {
  ...
  public es.caib.rfhab.persistence.TraduccioMapJPA getTraduccio(String idioma) {
    return (es.caib.rfhab.persistence.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, es.caib.rfhab.persistence.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
