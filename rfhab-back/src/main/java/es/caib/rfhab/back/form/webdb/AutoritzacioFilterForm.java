 ...
 */
@Component
public class AutoritzacioFilterForm extends RFHabBaseFilterForm implements AutoritzacioFields {
  ...
  private java.lang.String cai;

  public java.lang.String getCai() {
    return this.cai;
  }

  public void setCai(java.lang.String cai) {
    this.cai = cai;
  }
  ...
  public AutoritzacioFilterForm() {
  }
  
  public AutoritzacioFilterForm(AutoritzacioFilterForm __toClone) {
    super(__toClone);
  ...
  public List<Field<?>> getDefaultFilterByFields() {
    return new java.util.ArrayList<Field<?>>(Arrays.asList(new Field<?>[] { AUTORITZACIOID ,CODISIA ,PROCEDIMENT ,CAI ,DATAINICI ,DATAFI }));
  }
