...
import es.caib.rfhab.back.form.webdb.TraduccioForm;

import es.caib.rfhab.back.validator.webdb.TraduccioWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="traduccio.traduccio.plural", order=150, group=Tab.MENU_WEBDB)
@Controller
...
public class TraduccioController
    extends es.caib.rfhab.back.controller.RFHabBaseController<Traduccio, java.lang.Long> implements TraduccioFields {

  @EJB(mappedName = es.caib.rfhab.ejb.TraduccioService.JNDI_NAME)
