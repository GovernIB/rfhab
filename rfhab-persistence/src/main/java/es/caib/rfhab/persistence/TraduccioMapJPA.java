...
@Table(name = "rfh_traducciomap" , indexes = { 
        @Index(name="rfh_traducciomap_pk_i", columnList = "traducciomapid"),
        @Index(name="rfh_traducciomap_idiomaid_fk_i", columnList = "idiomaid")})
