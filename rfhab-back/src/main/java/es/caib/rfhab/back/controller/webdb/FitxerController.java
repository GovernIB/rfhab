...
import es.caib.rfhab.back.form.webdb.FitxerForm;

import es.caib.rfhab.back.validator.webdb.FitxerWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="fitxer.fitxer.plural", order=30, group=Tab.MENU_WEBDB)
@Controller
...
public class FitxerController
    extends es.caib.rfhab.back.controller.RFHabBaseController<Fitxer, java.lang.Long> implements FitxerFields {

  @EJB(mappedName = es.caib.rfhab.ejb.FitxerService.JNDI_NAME)
  protected es.caib.rfhab.ejb.FitxerService fitxerEjb;
