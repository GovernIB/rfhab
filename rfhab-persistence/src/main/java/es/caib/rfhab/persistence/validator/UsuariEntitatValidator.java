...
public class UsuariEntitatValidator<I extends UsuariEntitat>
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    ,es.caib.rfhab.model.dao.IUsuariEntitatManager __usuariEntitatManager) {
    ...
    if (__isNou__) { // Creació
      ...
      // Check Unique MULTIPLE for (entitatid, usuariid)
      if (__vr.getFieldErrorCount(ENTITATID) == 0 && __vr.getFieldErrorCount(USUARIID) == 0) {
        java.lang.Long __entitatid = __target__.getEntitatID();
        java.lang.Long __usuariid = __target__.getUsuariID();
        Long __count_ = null;
        try { __count_ = __usuariEntitatManager.count(org.fundaciobit.genapp.common.query.Where.AND(ENTITATID.equal(__entitatid), USUARIID.equal(__usuariid))); } catch(org.fundaciobit.genapp.common.i18n.I18NException e) { e.printStackTrace(); };
      ...
      // Check Unique MULTIPLE for (entitatid, usuariid)
      if (__vr.getFieldErrorCount(ENTITATID) == 0 && __vr.getFieldErrorCount(USUARIID) == 0 && __vr.getFieldErrorCount(USUARIENTITATID) == 0) {
        java.lang.Long __entitatid = __target__.getEntitatID();
        java.lang.Long __usuariid = __target__.getUsuariID();
        java.lang.Long __usuarientitatid = __target__.getUsuariEntitatID();
        Long __count_ = null;
        try { __count_ = __usuariEntitatManager.count(org.fundaciobit.genapp.common.query.Where.AND(ENTITATID.equal(__entitatid), USUARIID.equal(__usuariid), USUARIENTITATID.notEqual(__usuarientitatid))); } catch(org.fundaciobit.genapp.common.i18n.I18NException e) { e.printStackTrace(); };
        if (__count_ == null || __count_ != 0) {        
            __vr.rejectValue(ENTITATID, "genapp.validation.unique",
                new org.fundaciobit.genapp.common.i18n.I18NArgumentString(String.valueOf(__entitatid)),
                     new org.fundaciobit.genapp.common.i18n.I18NArgumentCode(get(ENTITATID)));
