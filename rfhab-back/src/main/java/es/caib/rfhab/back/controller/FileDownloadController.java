...
public class FileDownloadController {
  ...
  public static final String CONTEXTWEB = "/common/arxiu/";
  ...
  /**
   * Descarrega un fitxer local a través d'HTTP. Si deleteAfter és true, esborra
   * el fitxer després de la transferència.
   * 
   ...
   */
  public static void downloadLocalFile(String filePath, String filename, String contentType, boolean deleteAfter,
      HttpServletResponse response) {
    FileInputStream input = null;
    OutputStream output = null;
