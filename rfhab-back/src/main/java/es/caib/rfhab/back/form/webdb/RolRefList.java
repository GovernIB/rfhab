 ...
 */
@Component
public class RolRefList extends RefListBase
    implements RolFields {
  ...
  public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
    ...
    org.fundaciobit.genapp.common.query.Where _w1 = es.caib.rfhab.model.fields.TraduccioFields.TRADUCCIOID.in(rolEjb.executeQuery(_transSelect, where));
